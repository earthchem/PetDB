 ...
 *
 * 3. Set the form field variables below to the names of your input fields and form
 *
 * Optional:
 *
  ...
  if (GBrowserIsCompatible()) {
    ...
    google.maps.Event.addListener(map, "click", function(mark, latlng) {
        ...
        if (mark == null) {
          ...
          if (markSet == false) {
            marker = new google.maps.Marker(latlng, {draggable: true, icon: icon});
            ...
            google.maps.Event.addListener(marker, "dragend", function() {
                ...
                while (polygons.length > 0) {
                    map.removeOverlay(polygons.pop());
                }
