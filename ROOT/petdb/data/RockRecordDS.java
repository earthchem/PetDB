...
public class RockRecordDS  extends RecordDS {

	public RockRecordDS(ResultSet rs)
	{
		super(rs);
	}

	public RockRecordDS(ResultSet rs, String qry)
	{
		super(rs, qry);
	}
	 ...
	 synchronized(index) {
		...
		String prv_key = "";
			...
			int counter = -1;
				...
				{ 
                                	RockRecord pr = (RockRecord)data.elementAt(counter);
	...
	{
		return new RockRecord(rs, count);
