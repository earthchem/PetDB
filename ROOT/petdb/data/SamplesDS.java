...
public class SamplesDS  extends RecordDS {

	public SamplesDS(ResultSet rs)
	{
		super(rs);
	}

	public SamplesDS(ResultSet rs, String qry)
	{
		super(rs, qry);
	}
	 ...
	 synchronized(index) {
		...
		String prv_key = "";
			...
			int counter = -1;
				...
				{ 
                                	SamplesRecord pr = (SamplesRecord)data.elementAt(counter);
	...
	{
		return new SamplesRecord(rs, count);
